...
$username = 'fadzai.zaranyika';        // 
$password = 'fadzai00';            // The password to access the database (empty if none is set)
$dbname = 'webtech_fall2024_fadzai_zaranyika';      // The name of the database to connect to
